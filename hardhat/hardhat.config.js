...
module.exports = {
  ...
  // REACT_APP_PROVIDER=https://dai.poa.network in react-app/.env
...
task(
  ...
  async (_, { ethers }) => {
    ...
    console.log(
      "🔐 Account Generated as " + address + " and set as mnemonic in hardhat"
    );
    console.log(
...
task("mine", "Looks for a deployer account that will give leading zeros")
  ...
  .setAction(async (taskArgs, { network, ethers }) => {
    ...
    console.log(
      "⛏  Account Mined as " + address + " and set as mnemonic in hardhat"
    );
    console.log(
